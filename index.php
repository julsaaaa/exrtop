...
<head>
	...
	<title>C.gonzalez camping y pesca</title>
</head>
		...
		<div class="container mt-5 pt-5">
			...
			<div class="row align-items-center">
				<div class="col-lg-12 text-center mt-5">
					<div class="section_title">
						<h2>Gonzales casa de camping y pesca</h2>
					</div>
				</div>
			</div>
			<?php
			...
			<div class="row align-items-center">
				...
				while ($dataProduct = mysqli_fetch_array($resultadoProductos)) { ?>
					<div class="col-6 col-md-3 mt-5 text-center Products">
						<div class="card" style="max-height: 400px !important; min-height: 400px !important;background-color:#98FB98 !important;">
							<div>
